...
/// @notice Wraps Uniswap V3 and PancakeSwap V3 positions in the ERC721 non-fungible token interface
interface INonfungiblePositionManager {
    ...
    /// @notice Parameters for increasing liquidity in an existing position
    ...
    /// @notice Parameters for decreasing liquidity in an existing position
